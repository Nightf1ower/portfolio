(() => {
  ...
  loadScript('script[src^="/carnival-records-click-guard.js"]', '/carnival-records-click-guard.js?v=carnival-click-guard-5');
  ...
  loadScript('script[src^="/carnival-records-native-layout.js"]', '/carnival-records-native-layout.js?v=carnival-native-reset-1');
  loadScript('script[src^="/carnival-records-final-copy.js"]', '/carnival-records-final-copy.js?v=carnival-final-copy-1');
  loadScript('script[src^="/carnival-records-cleanup.js"]', '/carnival-records-cleanup.js?v=carnival-cleanup-reset-1');
  ...
  loadScript('script[src^="/fable-gradient-line-fix.js"]', '/fable-gradient-line-fix.js?v=fable-gradient-line-fix-5');
