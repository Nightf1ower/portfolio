(() => {
  ...
  loadScript('script[src^="/project-list-expansion.js"]', '/project-list-expansion.js?v=project-list-expansion-1');
  loadScript('script[src^="/project-card-layout-v2.js"]', '/project-card-layout-v2.js?v=project-card-layout-2');
