(() => {
  if (window.__desktopSiteExperienceLoaderV33) return;
  ...
  load('/portfolio-stable-project-shell.js?v=portfolio-stable-project-shell-5', 'portfolio-stable-project-shell-5');
