(() => {
  if (window.__desktopSiteExperienceLoaderV6) return;
  window.__desktopSiteExperienceLoaderV6 = true;
  ...
  load('/portfolio-final-qa-fixes.js?v=portfolio-final-qa-fixes-2', 'portfolio-final-qa-fixes-2');
